		...
		this.innerHTML = `
                      <div id="biblemenuanimation">
                        <div class="testamentsholderthumb">
                            ...
                            <a href="searchbible.html"><div id="searchhere"><span class="searchside">SEARCH THE ENTIRE BIBLE WITH SEARCH PAGE</span><img src="BiblePages/ssets/images/journal/search.svg" class="searchright" style="min-width: 20px; max-width:200px; min-height: 20px; max-height:200px; height:auto; width:70%;"></div></a>
